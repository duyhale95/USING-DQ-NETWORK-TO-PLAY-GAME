...
class Level1AI:
    ...
    def __init__(self, w=1320, h=720):
        ...
        # Colliders
        self.toprect = pygame.Rect(0, 0, 300, 500)
        self.collidedtopleft = True
        self.top1rect = pygame.Rect(300, 240, 590, 40)
        self.collidedtop1= False
        self.bottomleftrect = pygame.Rect(0, 575, 800, 50)
        self.collidedbottomleft = False
        self.left1rect = pygame.Rect(250, 200, 50, 300)
        self.collidedleft1 = False
        self.left2rect = pygame.Rect(50, 200, 150, 400)
    ...
    def _update_ui(self):
        ...
        # pygame.draw.rect(self.screen, BLACK, pygame.Rect(0, 0, 300, 500), 2) #TopLeft
        # pygame.draw.rect(self.screen, BLACK, pygame.Rect(300, 240, 590, 40), 2) #Top1
        # pygame.draw.rect(self.screen, BLACK, pygame.Rect(0, 575, 800, 50), 2) # BottomLeft
        # pygame.draw.rect(self.screen, BLACK, pygame.Rect(250, 500, 70, 20), 2) # Bot1
        # pygame.draw.rect(self.screen, BLACK, pygame.Rect(390, 505, 600, 20), 2) # Bot2
        ...
        # pygame.draw.rect(self.screen, BLACK, pygame.Rect(50, 200, 150, 400), 2) #Left2
        # pygame.draw.rect(self.screen, BLACK, pygame.Rect(300, 200, 25, 300), 2) #Left3
        # pygame.draw.rect(self.screen, BLACK, pygame.Rect(955, 260, 25, 300), 2) # Right1
